<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterpage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="EmpManageProject.aspx.cs" Inherits="EmpManageProject" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container">
                ...
                <div class="col-sm-4 col-lg-3 col-xs-12">
                    <div class="card">
                        <div class="card-block">
                            <h4 class="card-title" runat="server" id="nameTB">Project Location: <%# Eval("pProjectName") %></h4>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:impressiondesign_dbConnectionString %>" SelectCommand="SELECT * FROM [myProjects] WHERE (([pEmployee] = @pEmployee) AND ([pProjectStatus] = @pProjectStatus))">
            <SelectParameters>
                <asp:SessionParameter Name="pEmployee" SessionField="sName" Type="String" />
